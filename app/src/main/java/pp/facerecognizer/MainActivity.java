...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private boolean saveDectectface = false;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        shutterButton.setOnClickListener(view -> {
            //tracker.changeStatusCapture(loadBitmapFromView(this.findViewById(R.id.container)));
            this.saveDectectface= !this.saveDectectface;
            this.recognizer.setSaveFace(this.saveDectectface);
            if(this.saveDectectface) {
                this.shutterButton.setBackgroundTintList(ColorStateList.valueOf(Color.RED));
            } else {
                this.shutterButton.setBackgroundTintList(ColorStateList.valueOf(Color.GREEN));
            }
        });
    }
